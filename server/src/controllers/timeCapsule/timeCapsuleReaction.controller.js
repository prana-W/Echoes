...
const reactToTimeCapsule = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, "Reaction recorded successfully", reactionType));
});
/**
 * GET /api/timecapsule/:timecapsuleId/my-reaction
 * Fetch logged-in user's reaction for a time capsule
 */
