...
const addCommentToCapsule = asyncHandler(async (req, res) => {
    ...
    return res.status(statusCode.CREATED).json(
        new ApiResponse(statusCode.CREATED, "Comment added", comment)
    );
});
...
const editComment = asyncHandler(async (req, res) => {
    ...
    return res.json(
        new ApiResponse(statusCode.OK, "Comment updated", comment)
    );
});
...
const deleteComment = asyncHandler(async (req, res) => {
    ...
    return res.json(
        new ApiResponse(statusCode.OK, "Comment deleted")
    );
});
