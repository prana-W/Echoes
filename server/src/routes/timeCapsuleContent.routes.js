...
// Delete a video
router.delete('/video/:contentId', verifyAccessToken, deleteVideoContent);
...
// Delete audio
router.delete('/audio/:contentId', verifyAccessToken, deleteAudioContent);
...
// Add text
router.post('/texts/:timecapsuleId', verifyAccessToken, addTextToTimeCapsule);

// Delete text
router.delete('/texts/:contentId', verifyAccessToken, deleteTextContent);
